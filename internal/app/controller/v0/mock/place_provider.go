...
func (_m *PlaceProvider) PlacesByDistance(ctx context.Context, geoQ *query.Geo, skipN int64, resN int64) ([]place.Place, error) {
	ret := _m.Called(ctx, geoQ, skipN, resN)

	var r0 []place.Place
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *query.Geo, int64, int64) ([]place.Place, error)); ok {
		return rf(ctx, geoQ, skipN, resN)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *query.Geo, int64, int64) []place.Place); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *query.Geo, int64, int64) error); ok {
